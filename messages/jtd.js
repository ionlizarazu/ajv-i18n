...
module.exports = {
  ...
  _type: {
    ...
    eu: '{{#def.t}}{{? t == "number" }}zenbakia{{?? t == "integer"}}zenbaki osoa{{?? t == "string"}}testuzkoa{{?? t == "boolean"}}bolearra{{??}}{{=t}}{{?}}{{=n}} izan behar du',
  ...
  properties: {
    ...
    missing: {
      ...
      eu: "beharrezkoa den {{=e.params.missingProperty}} propietatea izan behar du",
  ...
  discriminator: {
    ...
    tag: {
      ...
      eu: '"{{=e.params.tag}}" etiketa testuzkoa izan behar da',
    ...
    mapping: {
      ...
      eu: '"{{=e.params.tag}}" etiketaren balioa mapeoan egon behar da',
  ...
  enum: {
    ...
    eu: "aurrez definitutako balio baten berdina izan behar da",
  ...
  union: {
    ...
    eu: '"union"-eko eskema batekin bat etorri behar du',
