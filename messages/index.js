...
module.exports = {
  ...
  _defaultMessage: {
    ...
    eu: '"{{=e.keyword}}" hitz gakoaren baliozkotzea pasa behar du',
  ...
  additionalItems: {
    ...
    eu: "{{#def.n}}ez ditu {{=n}} elementu baino gehiago izan",
  ...
  anyOf: {
    ...
    eu: '"anyOf"-eko eskemaren batekin bat etorri behar du',
  ...
  dependencies: {
    ...
    eu: "{{#def.n}}k {{=e.params.deps}} propietate{{#def.propPlural}} izan behar ditu, {{=e.params.property}} propietatea dagoenean",
  ...
  enum: {
    ...
    eu: "aurrezarritako balio baten berdina izan behar du",
  ...
  format: {
    ...
    eu: '"{{=e.params.format}}" formatuarekin bat etorri behar du',
  ...
  maxItems: {
    ...
    eu: "{{#def.n}}ezin d{{? n!=1 }}it{{?}}u {{? n!=1 }}{{=n}}{{?}} elementu {{? n==1 }}{{=n}} {{?}}baino gehiago izan",
  ...
  minItems: {
    ...
    eu: "{{#def.n}}ezin d{{? n!=1 }}it{{?}}u {{? n!=1 }}{{=n}} {{?}}elementu {{? n==1 }}{{=n}} {{?}}baino gutxiago izan",
  ...
  maxLength: {
    ...
    eu: "{{#def.n}}ezin d{{? n!=1 }}it{{?}}u {{? n!=1 }}{{=n}} {{?}}karaktere {{? n==1 }}{{=n}} {{?}}baino gehiago izan",
  ...
  minLength: {
    ...
    eu: "{{#def.n}}ezins d{{? n!=1 }}it{{?}}u {{? n!=1 }}{{=n}} {{?}}karaktere {{? n==1 }}{{=n}} {{?}}baino gutxiago izan",
  ...
  maxProperties: {
    ...
    eu: "{{#def.n}}ezin d{{? n!=1 }}it{{?}}u {{? n!=1 }}{{=n}} {{?}}propietate {{? n==1 }}{{=n}} {{?}}baino gehiago izan",
  ...
  minProperties: {
    ...
    eu: "{{#def.n}}ezin d{{? n!=1 }}it{{?}}u {{? n!=1 }}{{=n}} {{?}}propietate {{? n==1 }}{{=n}} {{?}}baino gutxiago izan",
  ...
  multipleOf: {
    ...
    eu: "{{=e.params.multipleOf}} zenbakiaren multiplo izan behar du",
  ...
  not: {
    ...
    eu: 'ezin du baliozkoa izan eskemako "not"-en arabera',
  ...
  oneOf: {
    ...
    eu: 'eskemako "oneOf" batekin bakarrik bat etorri behar du',
  ...
  pattern: {
    ...
    eu: '"{{=e.params.pattern}}" patroiarekin bat etorri behar du',
  ...
  required: {
    ...
    eu: "derrigorrezko {{=e.params.missingProperty}} propietatea izan behar du",
  ...
  type: {
    ...
    eu: '{{#def.t}}{{? t == "number" }}zenbakia{{?? t == "integer"}}zenbaki osoa{{?? t == "string"}}testua{{?? t == "boolean"}}bolearra{{??}}{{=t}}{{?}} izan behar du',
  ...
  unevaluatedProperties: {
    ...
    eu: "ezin du ebaluatu gabeko propietaterik izan",
  ...
  unevaluatedItems: {
    ...
    en: "{{#def.n}}must NOT have more than {{=n}} item{{#def.mPlural}}",
    de: "{{#def.n}}darf nicht mehr als {{=n}} Element{{#def.mPlural}} haben",
    eu: "{{#def.n}}ezin d{{? n!=1 }}it{{?}}u {{? n!=1 }}{{=n}}{{?}} item {{? n==1 }}{{=n}}{{?}} baino gehiago izan",
  ...
  uniqueItems: {
    ...
    eu: "ezin ditu bikoiztutako elementuak izan, (## {{=e.params.j}} eta {{=e.params.i}} elementuak berdinak dira)",
  ...
  propertyNames: {
    ...
    eu: "propietatea ez da baliozkoa",
  ...
  patternRequired: {
    ...
    eu: 'propietateak "{{=e.params.missingPattern}}" patroiarekin bat etorri behar du',
  ...
  const: {
    ...
    eu: "konstantearen berdina izan behar du",
  ...
  contains: {
    ...
    eu: "baliozko elementu bat izan behar du",
  ...
  if: {
    ...
    eu: '"{{=e.params.failingKeyword}}" eskemarekin bat etorri behar du',
  ...
  discriminator: {
    ...
    tag: {
      ...
      eu: '"{{=e.params.tag}}" etiketak testuzkoa izan behar du',
    ...
    mapping: {
      ...
      eu: '"{{=e.params.tag}}" etiketaren balioa "oneOf"-eko bat izan behar da',
